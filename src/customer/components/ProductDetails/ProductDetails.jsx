          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-50 text-sm'>56754 Ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>5643 Reviews</p>
                </div>
                   ...
                   <Grid item xs={5}>
                      ...
                      <div className='flex items-center space-x-3'>
                         <Rating value={4.6} precision={.5} readOnly />
                          <p className='opacity-60'>54673 Ratings</p>
                      </div>
